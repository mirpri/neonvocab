...
import { Trash2, LogOut, PartyPopper } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen text-slate-900 dark:text-slate-100 flex flex-col font-sans selection:bg-indigo-500/30 transition-colors duration-300">
      {!isLearning && (
        <NavBar
          theme={theme}
      ...
      <main className="flex-1 p-6 flex flex-col max-w-5xl mx-auto w-full relative z-10 overflow-x-hidden">
        <StatsBoard 
            stats={stats} 
